...
class Config{
	 ...
	 * @return string
	 */
	public static function fixYAMLIndexes(string $str){
	 ...
	 * @return bool
	 */
	public function exists($k, bool $lowercase = false){
		if($lowercase === true){
	 ...
	 * @return array
	 */
	public function getAll(bool $keys = false){
	 ...
	 * @return int
	 */
	private function fillDefaults(array $default, &$data){
		$changed = 0;
